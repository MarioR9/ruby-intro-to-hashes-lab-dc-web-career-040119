...
=======
	   :names => {:reading_railrod => {}, :pennsylvania_rail => {},:b_and_o_railroad => {}},
	   :rent_in_dollars => {:one_piece_woned => 25, :two_pieces_owned => 50, :three_pieces_owned => 100, :four_pieces_owned => 200}}}
>>>>>>> 5df5032460321c16a1737f908be6a9d45931dbd0
